...
<!-- 	
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav nav-pills nav-justified">
        <li ><a href="#injuredPerson" id="personalButton">Personal</a></li>
        <li ><a href="#accidentInformation" id="accidentButton">Accident</a></li>
        <li><a href="#injuryDetails" id="injuryButton">Injury</a></li>
        <li><a href="#employmentDetails" id="employmentButton">Employment</a></li>
        <li><a href="#reviewAndSubmit" id="finalSubmitButton">Submit</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
			...
			<form role="form" style="text-align: left;">
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-12">
						<div class="col-lg-12 page-title" style="text-align: center; margin-top: 50px; color: #7089a4">Injured Person's Information <div id='hideInjured'>(Click to Show Details)</div></div>
						
					</div>
				</div>
				<div class="injuredPerson" id='injuredPerson'>
					<div class="col-lg-12">
						<div class="form-group col-lg-6">
				...
				<button type="button" class="btn btn-primary skier-button" id="closeToNextInjured"><span>Next</span></button>
					...
					<!------------------------------------------------------------------------------------- END OF INJURED PERON'S INFORMATION ------------------------------------------------------------------>


					<!-------------------------------------------------------------------------------------------- ACCIDENT INFORMATION START ------------------------------------------------------------------->
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-12">				
						<div class="col-lg-12 page-title" style="text-align: center; margin-top: 50px; color: #7089a4" id="accidentInformation">Accident Information<div id='hideAccident'>(Click to Show Details)</div></div>
					</div>
				</div>
				<div class="accident" id='accident'>
				...
				<button type="button" class="btn btn-primary skier-button" id="closeToNextAccident"><span>Next</span></button>
				</div>

				<!------------------------------------------------------------------------- End Accident Information ---------------------------------------------------------------------------------->
				

				<!------------------------------------------------------------------------------ Injury Details --------------------------------------------------------------------------------------->
				<div class="col-lg-12">
					<div class="form-group col-lg-12">				
						<div class="col-lg-12 page-title" style="text-align: center; margin-top: 50px; color: #7089a4" id="injuryDetails">Injury Details<div id='hideInjury'>(Click to Show Details)</div></div>
					</div>
				</div>
				<div class="injury" id="injury">
					...
					<div class="form-group col-lg-4">
						<label for="injuryType" class="skier-label">Type of Injury</label>
					...
					<div class="form-group col-lg-4">
						<label for="illnessType" class="skier-label">Type of Illness</label>
					...
					<div class="form-group col-lg-4">
						<label for="injuryBodyPart" class="skier-label">Affected Body Part</label>
					...
					<div class="form-group col-lg-6">
						...
						<?php if ($formdata['staffPaid'] == 'Yes') { print ' checked="checked"'; } ?> /> Yes &nbsp;
							<input type="radio" name="staffPaid" id="staffPaid_no" value="No"<?php if ($formdata['staffPaid'] == 'No') { print ' checked="checked"'; } ?> /> No
						</div>
					</div>
				</div>
				<button type="button" class="btn btn-primary skier-button" id="closeToNextInjury"><span>Next</span></button>
						</div>
				<!---------------------------------------------------------------------------------------------- End Injury Details --------------------------------------------------------------------------------------------->	
				...
				<div class="col-lg-12">
					<div class="form-group col-lg-12">				
						<div class="col-lg-12 page-title" style="text-align: center; margin-top: 50px; color: #7089a4" id="employmentDetails">Employment Details<div id='hideEmployment'>(Click to Show Details)</div></div>
					</div>
				</div>
				...
				<button type="button" class="btn btn-primary skier-button" id="closeToNextEmployment"><span>Next</span></button>
				...
				<!-------------------------------------------------------------------------------------------------- Form Filled Out By  ----------------------------------------------------------------------------------------->
					...
					<div class="form-group col-lg-12">
						<div class="col-lg-12 page-title" style="text-align: center; margin-top: 50px; color: #7089a4" id='reviewAndSubmit'>This form was filled out by</div>
					</div>
